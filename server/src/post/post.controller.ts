import { Controller, Get, Post, Body, Patch, Param, Delete, Ip, Query, UseFilters,} from '@nestjs/common';
import { PostService } from './post.service';
import { CreatePostCommentDto, CreatePostDto, CreatePostMediaDto, createPostOrCommentLikeDto } from './dto/create-post.dto';
import { updatePostCommentContentDto, UpdatePostContentDto } from './dto/update-post.dto';
...
export class PostController {
  ...
  @Post('post/create')
  create(@Ip() ip:string,@Body() createPostDto: CreatePostDto) {
